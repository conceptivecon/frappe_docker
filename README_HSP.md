...
The `volume-permissions` init service runs first to set host bind-mount ownership
for Frappe/MariaDB/Redis so `configurator` can write configs successfully.
